...
public class AccessPolicy {
    private final List<Rule> rules = Arrays.asList(
            ...
            Rule.prefix("/api/attendance/daily/recalc", "*", "HR", "ADMIN"),
            Rule.prefix("/api/attendance/daily/department", "GET", "HR", "ADMIN", "MANAGER"),
            Rule.prefix("/api/attendance/daily/abnormal", "GET", "HR", "ADMIN", "MANAGER"),
            ...
            Rule.path("/api/notices", "POST", "ADMIN", "HR"),
            Rule.suffix("/api/notices/", "/read", "POST"),
            Rule.suffix("/api/notices/", "/publish", "POST", "ADMIN", "HR"),
            Rule.suffix("/api/notices/", "/revoke", "POST", "ADMIN", "HR"),
            Rule.prefix("/api/notices/", "PUT", "ADMIN", "HR"),
            Rule.path("/api/meetings/rooms", "POST", "ADMIN", "HR"),
