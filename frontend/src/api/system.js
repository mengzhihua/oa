...
export const systemApi = {
  ...
  resetPassword: (id, data) => http.post(`/system/users/${id}/reset-password`, data),
  ...
  assignRoles: (id, data) => http.post(`/system/users/${id}/roles`, data),
  assignMenus: (id, data) => http.post(`/system/roles/${id}/menus`, data),
  logs: (params) => http.get('/system/oplogs', { params }),
}
